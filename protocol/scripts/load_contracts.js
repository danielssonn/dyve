...
// reusing "NFTPool" at 0x1605fa454459bfd6de7bd173F13DD5a9d4039790
// reusing "NFTLoanVault" at 0x69544a7E9bBd934D0f483b1E2F044C29f2700824
...
const nftLoansAddress = "0x69544a7E9bBd934D0f483b1E2F044C29f2700824"
...
const nftPoolAddress = "0x1605fa454459bfd6de7bd173F13DD5a9d4039790"
...
async function loan8670() {
    ...
    const tx = {
        ...
        nonce: nonce,
        gas: 7900000,
        data: nftLoansContract.methods.borrowedOn('0xFf961b90F914bB9c3d2B839DDdF6C1c926B712E6', { listedOn: 1646166783, tknAddress: '0xbce3781ae7ca1a5e050bd9c4c77369867ebc307e', tknId: 8670, compliance: 'pass', dailyFee: 5, returnCondition: 1, expiry: 1660595583, collateral: { amount: 12000000000, currency: 'ETH' } }, 20, 1646944383, 8000000000, 6000000000, 2000000000, 6498, '0xbce3781ae7ca1a5e050bd9c4c77369867ebc307e', 1, 1648413183).encodeABI(),
    }
    await signAndSend(tx);
}
async function loan1167() {
    ...
    const tx = {
        ...
        nonce: nonce,
        gas: 7900000,
        data: nftLoansContract.methods.borrowedOn('0xFf961b90F914bB9c3d2B839DDdF6C1c926B712E6', { listedOn: 1642192383, tknAddress: '0x7f36182dee28c45de6072a34d29855bae76dbe2f', tknId: 1167, compliance: 'pass', dailyFee: 1, returnCondition: 1, expiry: 1649968383, collateral: { amount: 2250000000, currency: 'ETH' } }, 30, 1642278783, 1500000000, 850000000, 650000000, 66, '0x7f36182dee28c45de6072a34d29855bae76dbe2f', 1, 1644870783).encodeABI(),
    }
    await signAndSend(tx);
}
